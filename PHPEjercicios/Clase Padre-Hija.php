...
class Father {
 public function oneMethod () { echo "Función unMetodo de Padre";}
}
class Son extends Father {
 public function oneMethod() { echo "Función unMetodo de Hija"; }
}
$p = new Father;
...
class Pare {
 public function unMetode () { echo "Función unMetodo de Padre";}
}
